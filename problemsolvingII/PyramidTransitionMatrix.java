...
public class PyramidTransitionMatrix {
    static void main() {
        System.out.println(pyramidTransition("", new ArrayList<>()));
    }
    ...
    private static boolean dfs(String bottom, String next, int index,
    ...
    public boolean pyramidTransitionFast(String bottom, List<String> allowed) {
